<div class="s3-details">
	<?php if ( ! $s3object ) : ?>
		<div class="misc-pub-section">
			<em class="not-copied"><?php _e( 'This item has not been copied to S3 yet.', 'as3cf-pro' ); ?></em>
		</div>
	<?php else : ?>
		<div class="misc-pub-section">
		...
		<div class="misc-pub-section">
			...
			<div class="s3-value"><?php echo isset( $s3object['acl'] ) ? $s3object['acl'] : $this::DEFAULT_ACL; ?></div>
		</div>
		<?php if ( $user_can_perform_actions && ! $local_file_exists ) : ?>
			<div class="misc-pub-section">
				<div class="not-copied"><?php _e( 'File does not exist on server', 'as3cf-pro' ); ?></div>
