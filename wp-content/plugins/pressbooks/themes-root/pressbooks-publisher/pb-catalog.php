...
<head>
	...
	<title><?php echo ucfirst( get_userdata( $pb_user_id )->user_login ); _e( '\'s Catalog', 'pressbooks' ); ?> | Lumen Learning</title>
	<link rel="stylesheet" type="text/css" href="<?php echo PB_PLUGIN_URL; ?>assets/css/style-catalog.css?ver=2" />
	<link rel="stylesheet" type="text/css" href="<?php echo PB_PLUGIN_URL; ?>themes-root/pressbooks-publisher/candela_assets/css/style-catalog.css?ver=2" />
...
<div class="catalog-wrap">
	...
	<div id="catalog-sidebar" class="catalog-sidebar">
		<h2 class="pressbooks-logo">
			<a href="<?php echo network_site_url(); ?>">Lumen Learning</a>
		</h2>
					...
					<div class="book">
						<a href="<?php echo get_site_url( $b['blogs_id'], '', 'http'  ); ?>">
							<p class="book-description">
								...
								<span class="book-link">&rarr;</span>
							</p>
