		...
		<tr<?php if ( in_array( 'method', $errors ) ) echo ' class="form-invalid"'; ?>>
			...
			<td>
				<ul id="pb-latex-method-switch">
					...
					<li><label for="pb-latex-method-katex"><input type="radio" name="pb_latex[method]" id="pb-latex-method-katex" value='katex'<?php checked( 'katex', $values['method'] ); ?> /> <?php _x( 'KaTeX + MathJax in-browser', 'pb-latex' ); ?></label></li>
				</ul>
			</td>
		</tr>
